...
const struct SpecialBattleFrontierTrainer gSpecialTowerTrainers[] =
{
	...
	},
	{
		...
		.regularSpreads =	gSpecialTowerSpread_Surge,
		.regSpreadSize = 	NELEMS(gSpecialTowerSpread_Surge),
		.legendarySpreads =	gSpecialTowerSpread_Surge,
		.legSpreadSize = 	NELEMS(gSpecialTowerSpread_Surge),
		.songId = 			296,
		.isMonotype = 		TRUE,
	},
};
