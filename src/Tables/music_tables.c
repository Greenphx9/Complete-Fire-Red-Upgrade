...
const u16 gClassBasedBattleBGM[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_CHAMPION_DP] = MUS_DP_VS_CHAMPION,
	[CLASS_PKMN_TRAINER_DPPT] = MUS_DP_VS_RIVAL,
};
...
const u16 gWildSpeciesBasedBattleBGM[] =
{
	...
	[SPECIES_GROUDON] = MUS_RS_VS_LEGEND,
	[SPECIES_KYOGRE] = MUS_RS_VS_LEGEND,
	[SPECIES_RAYQUAZA] = MUS_RS_VS_LEGEND,
	...
	[SPECIES_REGIGIGAS] = BGM_BATTLE_REGI_TRIO,
	[SPECIES_DIALGA] = MUS_DP_VS_DIALGA_PALKIA,
	[SPECIES_PALKIA] = MUS_DP_VS_DIALGA_PALKIA,
	[SPECIES_GIRATINA] = MUS_PL_VS_GIRATINA,
	[SPECIES_ARCEUS] = MUS_DP_VS_ARCEUS,
	[SPECIES_MANAPHY] = MUS_DP_VS_LEGEND,
	[SPECIES_DARKRAI] = MUS_DP_VS_LEGEND,
	[SPECIES_CRESSELIA] = MUS_DP_VS_LEGEND,
};
