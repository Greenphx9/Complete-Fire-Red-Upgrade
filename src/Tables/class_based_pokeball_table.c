...
const u8 gClassPokeBalls[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_ORACLE] =  		  BALL_TYPE_POKE_BALL,
	...
	[CLASS_CREATOR] =         BALL_TYPE_ULTRA_BALL,
	[CLASS_CHAMPION_DP] =     BALL_TYPE_ULTRA_BALL,
	[CLASS_POKEMANIAC_RS] =   BALL_TYPE_PREMIER_BALL,
	[CLASS_PKMN_TRAINER_RSE] =    BALL_TYPE_POKE_BALL,
	[CLASS_PKMN_TRAINER_DPPT] =   BALL_TYPE_POKE_BALL,
	...
	[CLASS_DOC_TEAM_MEMBER] = BALL_TYPE_ULTRA_BALL,
