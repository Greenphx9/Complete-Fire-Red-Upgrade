...
.equ MOVE_BREAKNECK_BLITZ_P, 0x311        
.equ MOVE_BREAKNECK_BLITZ_S, 0x312          
.equ MOVE_ALL_OUT_PUMMELING_P, 0x313          
.equ MOVE_ALL_OUT_PUMMELING_S, 0x314          
.equ MOVE_SUPERSONIC_SKYSTRIKE_P, 0x315          
.equ MOVE_SUPERSONIC_SKYSTRIKE_S, 0x316          
.equ MOVE_ACID_DOWNPOUR_P, 0x317   
.equ MOVE_ACID_DOWNPOUR_S, 0x318          
.equ MOVE_TECTONIC_RAGE_P, 0x319          
.equ MOVE_TECTONIC_RAGE_S, 0x31a          
.equ MOVE_CONTINENTAL_CRUSH_P, 0x31b       
.equ MOVE_CONTINENTAL_CRUSH_S, 0x31c          
.equ MOVE_SAVAGE_SPIN_OUT_P, 0x31d        
.equ MOVE_SAVAGE_SPIN_OUT_S, 0x31e         
.equ MOVE_NEVER_ENDING_NIGHTMARE_P, 0x31f          
.equ MOVE_NEVER_ENDING_NIGHTMARE_S, 0x320         
.equ MOVE_CORKSCREW_CRASH_P, 0x321          
.equ MOVE_CORKSCREW_CRASH_S, 0x322          
.equ MOVE_INFERNO_OVERDRIVE_P, 0x323          
.equ MOVE_INFERNO_OVERDRIVE_S, 0x324          
.equ MOVE_HYDRO_VORTEX_P, 0x325         
.equ MOVE_HYDRO_VORTEX_S, 0x326          
.equ MOVE_BLOOM_DOOM_P, 0x327          
.equ MOVE_BLOOM_DOOM_S, 0x328          
.equ MOVE_GIGAVOLT_HAVOC_P, 0x329         
.equ MOVE_GIGAVOLT_HAVOC_S, 0x32a         
.equ MOVE_SHATTERED_PSYCHE_P, 0x32b          
.equ MOVE_SHATTERED_PSYCHE_S, 0x32c         
.equ MOVE_SUBZERO_SLAMMER_P, 0x32d        
.equ MOVE_SUBZERO_SLAMMER_S, 0x32e       
.equ MOVE_DEVASTATING_DRAKE_P, 0x32f         
.equ MOVE_DEVASTATING_DRAKE_S, 0x330        
.equ MOVE_BLACK_HOLE_ECLIPSE_P, 0x331          
.equ MOVE_BLACK_HOLE_ECLIPSE_S, 0x332          
.equ MOVE_TWINKLE_TACKLE_P, 0x333          
.equ MOVE_TWINKLE_TACKLE_S, 0x334          

.equ MOVE_CATASTROPIKA, 0x335        
.equ MOVE_00000822_VOLT_THUNDERBOLT, 0x337          
.equ MOVE_STOKED_SPARKSURFER, 0x338          
.equ MOVE_EXTREME_EVOBOOST, 0x339          
.equ MOVE_PULVERIZING_PANCAKE, 0x33a          
.equ MOVE_GENESIS_SUPERNOVA, 0x33b          
.equ MOVE_SINISTER_ARROW_RAID, 0x33c         
.equ MOVE_MALICIOUS_MOONSAULT, 0x33d        
.equ MOVE_OCEANIC_OPERETTA, 0x33e      
.equ MOVE_SPLINTERED_STORMSHARDS, 0x33f          
.equ MOVE_LETS_SNUGGLE_FOREVER, 0x340          
.equ MOVE_CLANGOROUS_SOULBLAZE, 0x341          
.equ MOVE_GUARDIAN_OF_ALOLA, 0x342         
.equ MOVE_SEARING_SUNRAZE_SMASH, 0x343          
.equ MOVE_MENACING_MOONRAZE_MAELSTROM, 0x344          
.equ MOVE_LIGHT_THAT_BURNS_THE_SKY, 0x345   
.equ MOVE_SOUL_STEALING_838_STAR_STRIKE, 0x347    
