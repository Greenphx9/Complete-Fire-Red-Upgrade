...
void __attribute__((long_call)) DestroyMonIconInternal(struct Sprite * sprite);
u8 __attribute__((long_call)) CreateMonIconSprite(const struct MonIconSpriteTemplate * template, s16 x, s16 y, u8 subpriority);
