...
void __attribute__((long_call)) ScriptFreezeObjectEvents(void);
void __attribute__((long_call)) OverworldBasic(void);
void __attribute__((long_call)) SetFieldVBlankCallback(void);
bool32 __attribute__((long_call)) sub_8056CD8(u8 *state);
void __attribute__((long_call)) ReloadObjectsAndRunReturnToFieldMapScript(void);
void __attribute__((long_call)) InitOverworldBgs(void);
void __attribute__((long_call)) QuestLog_InitPalettesBackup(void);
void __attribute__((long_call)) ResumeMap(bool32 a0);
void __attribute__((long_call)) sub_8057114(void);
void __attribute__((long_call)) sub_8056F08(void);
void __attribute__((long_call)) SetHelpContextForMap(void);
bool8 __attribute__((long_call)) map_post_load_hook_exec(void);
void __attribute__((long_call)) InitFieldMessageBox(void);
void __attribute__((long_call)) PlayerForceSetHeldMovement(u8 movementActionId);
void __attribute__((long_call)) sub_8115798(void);
void __attribute__((long_call)) UpdateCameraPanning(void);
void __attribute__((long_call)) UpdateTilesetAnimations(void);
bool8 __attribute__((long_call)) QuestLog_SchedulePlaybackCB(void (*func)(void));
void __attribute__((long_call)) QLPlaybackCB_DestroyScriptMenuMonPicSprites(void);
void __attribute__((long_call)) Overworld_CreditsMainCB(void);
void __attribute__((long_call)) LoadStdWindowFrameGfx(void);
void __attribute__((long_call)) InitOverworldBgs_NoResetHeap(void);